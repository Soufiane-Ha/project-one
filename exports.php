            ...
            <table>
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
                    <tr>
                        ...
                        <td><input type="button" name="" id="more" value="More" onclick="window.location.href='details.php';"></td>
                        <td><input type="button" name="" id="edit" value="Edit"></td>
                    </tr>
                <?php $i++; endwhile;?>
                </tbody>
            </table>
